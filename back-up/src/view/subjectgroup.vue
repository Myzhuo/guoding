<template>
    <div class="swiper">
        ...
        <swiper-slide v-for="(item, index) in subjectList" :key='index'>
            <img :src="item.group_img"  @click="Onsubject(item.group_id,item.new_type,item)">
            <span class="wenzi">{{item.group_name}}</span>
        </swiper-slide>
        </swiper>
        <div class="swiper-bg">
        </div>
